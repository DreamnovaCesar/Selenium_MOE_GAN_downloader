...
from ..domain.DownloadGirlsMOE import DownloadGirlsMOE
...
class WaifusDownloadCSV(DownloadGirlsMOE):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.__Number_images = kwargs.get('iter', None)

        self.__Time_interval = 0.05
        self.__Initial = 5

        # * utf_8_sig
        with open(self.__CSV, 'r', encoding = 'utf_8_sig') as CSV:
            ...
            self.__Folder_CSV = Data['Folder'].tolist()
    ...
    def get_images_waifus_random(self) -> None:
        ...
        for i in range(self.__Number_images):
            ...
            Image_folder = os.path.join(self.__Folder, Image_name)
    ...
    def __init__(self, csv_file):
        ...
        self.models = data['Model'].tolist()
        self.hair_colors = data['Hair color'].tolist()
        self.hair_styles = data['Hair style'].tolist()
        self.eye_colors = data['Eye color'].tolist()
        ...
        self.folders = data['Folder'].tolist()
...
class WaifusDownloadCSV(DownloadGirlsMOE):
    ...
    # * Initializing (Constructor)
    def __init__(self, CSVReader : DataLoaderCSV, CSV: str, Folder: str, Number_images: int) -> None:

        # * Instance attributes
        self.__Folder_CSV = CSV
        self.__Folder_images = Folder
    ...
    def get_images_waifus_settings(self) -> None:
        ...
        for k in range(len(self.__Model)):
            ...
            for i in range(self.__Epochs[k]):
                ...
                # * Direction exist
                Exist_dir = os.path.isdir('{}/Girl_{}_{}_{}'.format(self.__Folder, self.__Hair_color[k], self.__Hair_style[k], self.__Eye_color[k])) 

                if Exist_dir == False:
                    New_folder = '{}/Girl_{}_{}_{}'.format(self.__Folder, self.__Hair_color[k], self.__Hair_style[k], self.__Eye_color[k])
                    os.mkdir(New_folder)
                else:
                    New_folder = '{}/Girl_{}_{}_{}'.format(self.__Folder, self.__Hair_color[k], self.__Hair_style[k], self.__Eye_color[k])
