...
_XPATH_OFF_BUTTON_ = [_XPATH_DARK_SKIN_OFF_BUTTON_,
                     _XPATH_BLUSH_OFF_BUTTON_,
                     _XPATH_SMILE_OFF_BUTTON_,
                     _XPATH_OPEN_MOUTH_OFF_BUTTON_,
                     _XPATH_HAT_OFF_BUTTON_,
                     _XPATH_RIBBON_OFF_BUTTON_,
                     _XPATH_GLASSES_OFF_BUTTON_]

_XPATH_RANDOM_BUTTON_ = [_XPATH_DARK_SKIN_RANDOM_BUTTON_,
                        _XPATH_BLUSH_RANDOM_BUTTON_,
                        _XPATH_SMILE_RANDOM_BUTTON_,
                        _XPATH_OPEN_MOUTH_RANDOM_BUTTON_,
                        _XPATH_HAT_RANDOM_BUTTON_,
                        _XPATH_RIBBON_RANDOM_BUTTON_,
                        _XPATH_GLASSES_RANDOM_BUTTON_]

_XPATH_ON_BUTTON_ = [_XPATH_DARK_SKIN_ON_BUTTON_,
                     _XPATH_BLUSH_ON_BUTTON_,
                     _XPATH_SMILE_ON_BUTTON_,
                     _XPATH_OPEN_MOUTH_ON_BUTTON_,
                     _XPATH_HAT_ON_BUTTON_,
                     _XPATH_RIBBON_ON_BUTTON_,
                     _XPATH_GLASSES_ON_BUTTON_]